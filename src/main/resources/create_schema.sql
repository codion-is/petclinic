...
CREATE TABLE petclinic.visit (
  ...
  insert_user VARCHAR(60) DEFAULT USER() NOT NULL,
...
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Leo', '2010-09-07', 4.10, 1, 1);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Basil', '2012-08-06', 0.12, 6, 2);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Rosy', '2011-04-17', 11.50, 2, 3);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Jewel', '2010-03-07', 9.75, 2, 3);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Iggy', '2010-11-30', 0.35, 3, 4);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('George', '2010-01-20', 2.20, 4, 5);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Samantha', '2012-09-04', 3.85, 1, 6);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Max', '2012-09-04', 5.20, 1, 6);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Lucky', '2011-08-06', 0.09, 5, 7);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Mulligan', '2007-02-24', 14.30, 2, 8);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Freddy', '2010-03-09', 0.11, 5, 9);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Lucky', '2010-06-24', 8.60, 2, 10);
INSERT INTO petclinic.pet(name, birth_date, weight_kg, type_id, owner_id) VALUES ('Sly', '2012-06-08', 4.45, 1, 10);
